...
namespace SpriteShadows.Plugins.Editor.JetBrains
{
  ...
  ""version"": ""{1}""
    ...
    static bool OnOpenedAsset(int instanceId, int line)
    {
      if (Enabled)
      {
        ...
        {
          var args = string.Format("{0}{1}{0} --line {2} {0}{3}{0}", "\"", _slnFile, line, assetFilePath);
    ...
    static void MenuOpenProject()
    {
      ...
      // Load Project
      CallRider(string.Format("{0}{1}{0}", "\"", _slnFile));
    }
